 ...
 */
final class Version20250417170833 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            CREATE TABLE competitors (id INT AUTO_INCREMENT NOT NULL, position_id INT NOT NULL, lastname VARCHAR(30) NOT NULL, firstname VARCHAR(30) NOT NULL, ffa_licence VARCHAR(15) NOT NULL, date_birth DATETIME NOT NULL COMMENT '(DC2Type:datetime_immutable)', flyingclub VARCHAR(30) DEFAULT NULL, email VARCHAR(128) NOT NULL, phone VARCHAR(30) DEFAULT NULL, gender VARCHAR(255) DEFAULT NULL, committee VARCHAR(255) NOT NULL, polo_size VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_2DED50C648C7D41B (ffa_licence), INDEX IDX_2DED50C6DD842E46 (position_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE competitors ADD CONSTRAINT FK_2DED50C6DD842E46 FOREIGN KEY (position_id) REFERENCES position (id)
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE competitions ADD CONSTRAINT FK_A7DD463D652C543E FOREIGN KEY (type_comp_id) REFERENCES type_competition (id)
        SQL);
        $this->addSql(<<<'SQL'
            CREATE INDEX IDX_A7DD463D652C543E ON competitions (type_comp_id)
        SQL);
        $this->addSql(<<<'SQL'
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            ALTER TABLE competitions DROP FOREIGN KEY FK_A7DD463D652C543E
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE competitors DROP FOREIGN KEY FK_2DED50C6DD842E46
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            DROP INDEX IDX_A7DD463D652C543E ON competitions
        SQL);
        $this->addSql(<<<'SQL'
